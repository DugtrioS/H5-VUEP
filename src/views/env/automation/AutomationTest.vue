        ...
        <el-row :span="24" class="row-title">
            <el-col :span="4">
                ...
                <div class="api-title" style="cursor:pointer;">
                    <router-link :to="{ name: '用例列表', params: {project_id: 81}}" style='text-decoration: none;color: aliceblue;'>
                        所有用例
                    </router-link>
                </div>
                <aside>
                    ...
                    <el-menu default-active="2" class="el-menu-vertical-demo" active-text-color="rgb(32, 160, 255)" :unique-opened="true">
                        <template v-for="(item,index) in groupData">
                            <router-link :to="{ name: '分组用例列表', params: {project_id: 81, firstGroup: 11}}" style="text-decoration:none;">
                    ...
                    if (valid) {
                        ...
                        this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            $.ajax({
                                ...
                                async: true,
                                data: JSON.stringify({ project_id: 81,
